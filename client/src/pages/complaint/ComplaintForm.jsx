...
const ComplaintForm = () => {
  return (
    <div className='flex flex-col justify-center items-center bg-gray-bg p-4 sm:p-8'>
      <div className='flex flex-row items-center w-full sm:justify-center'>
        <img
          src={img}
          alt="Profile"
      ...
      <Card className="w-full sm:w-1/2 mx-auto mt-5 rounded-3xl shadow-lg shadow-gray-800/50">
        <CardBody>
          <Typography variant="h6" className="mb-2 text-gray-600"> Booking Id : 12aa21w </Typography>
          ...
          <Typography variant="h6" className="mb-2 text-invoice"> Invoice </Typography>
          ...
          <div className='flex gap-8 justify-end mt-6 mr-14  sm-only:-mt-2 sm-only:mr-3'> 
            <Typography variant="body2" className="mt-8 text-table"> Grand Total</Typography>
             <Typography variant="body2" className="mt-8 text-table"> 300 </Typography> 
             </div>
      ...
      <div className="flex flex-col gap-5 w-full sm:w-1/2 m-5">
        <input type="text" className='w-full p-4 border border-gray-300 rounded-xl  text-lg shadow-lg shadow-gray-800/50' placeholder='Title'/>
        <textarea id="description" className="w-full p-4 border border-gray-300 rounded-xl  text-lg shadow-lg shadow-gray-800/50" rows="7" placeholder="Description"></textarea>
        <label className='w-full p-4 flex items-center justify-between border border-gray-300 text-gray-400  text-lg shadow-lg shadow-gray-800/50 bg-white rounded-xl' htmlFor='imgselector'>Images & Videos
        <BiImages className='text-3xl text-gray-600'/>
        </label>
