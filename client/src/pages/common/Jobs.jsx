...
function Jobs() {
  return (
    <div className="bg-background-color">
      ...
      {/* First Card */}
      <div className="flex items-center justify-center py-20 sm:w-6/5 md:w-6/5 lg:w-6/5 xl:w-6/5 ">
        <Card className="flex flex-row w-[600px] shadow-2xl rounded-3xl m-3">
          {/* Left Grey Section */}
          <div className="w-1/12 bg-card-color rounded-s-3xl"></div>
          ...
          <div className="w-11/12 p-4">
            <CardBody>
              ...
              <div className="flex items-center justify-between mb-2">
                <Typography variant="h5" color="blue-gray">
                  Tap Repair
                   ...
                   <FaRegCircle size={30}  className='bg-side-color rounded-full ' />
                   <p className='px-2 text-gray-400 font-medium'>keshavan</p>
                  
                   </div>
                   <p className='font-medium text-gray-400'>Active</p>
                     
                   <div className='flex  items-center space-x-2'>
                   <SlCalender className='text-orange-400' /> 
                    <p className='font-medium text-gray-400'>March 20,2021 </p>
                    <CiClock2  className='text-orange-400'/>
                    <p className='font-nano text-gray-400'>9.00 - 10.00 AM</p>
                   </div>
                </Typography>
              ...
              <Typography>
               ...
               <p className='font-medium text-xl text-gray-400 '>Amount : 300 /- </p>
     ...
     <div className="flex items-center justify-center  sm:w-6/5 md:w-6/5 lg:w-6/5 xl:w-6/5  ">
