  ...
  return (
    <div className=''>
      ...
      <div className='bg-gray-300 w-full h-20 flex'>
        <button
          className={`w-1/2 p-4 ${activeTab === 'faq' ? 'bg-gray-300 text-black border-b-2 border-blue-900' : 'bg-white text-gray-600'}`}
          onClick={() => setActiveTab('faq')}
        >
          faqFAQ
        </button>
        <button
          className={`w-1/2 p-4 ${activeTab === 'contact' ? 'bg-gray-300 text-black border-b-2 border-blue-900' : 'bg-white text-gray-600'}`}
