...
const Terms = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col p-0 m-0">
      <div className="bg-custom-dark-purple text-white p-6 pt-12 h-28 flex items-center justify-between"> {/* Increased padding and height */}
      ...
      <div className="flex-grow p-6 pt-8  "> {/* Added pt-8 pb-8 for padding on top and bottom */}
        <div className="space-y-4 md:space-y-0 sm:mt-24 md:mt-0"> {/* Added sm:mt-24 for more space at the top on mobile only */}
        ...
        {/* Horizontal Line */}
        <div className="mt-8 space-y-4 md:space-y-0 sm:mb-24 md:mb-0"> {/* Added sm:mb-24 for more space at the bottom on mobile only */}
      ...
      {/* <hr className="border-b-8 w-1/2 border-gray-300 mx-20 my-12" />  */}
